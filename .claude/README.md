...
Productivity helpers for roadmap/spec-driven work in `living-doc-generator-pdf`, copied and
adapted from the ecosystem reference copy in `living-doc-collector-gh/.claude/`.
...
here is `sdet` plus the concrete repo mock surface. The concrete mock/fixture cheat-table
for this repo lives in `test-author.md`; `/verify-pr-ready` invokes `reviewer`.
