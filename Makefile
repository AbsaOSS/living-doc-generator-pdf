# Quality-gate command vocabulary for living-doc-generator-pdf.
#
...
format: ## Reformat all tracked Python files with ruff --fix then Black.
...
lint: ## Run ruff then Pylint and enforce the minimum score.
	ruff check $(PY_FILES)
